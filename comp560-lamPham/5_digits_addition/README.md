# 5-Digit Addition Language Model Experiment

This folder trains and evaluates a 5-digit addition model using the shared trainer in `../common/train.py`.

## Quick Start

Prepare data:
```bash
cd 5_digits_addition
