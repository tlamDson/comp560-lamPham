"""
Sample and automatically verify 4-digit addition results.
...
print("AUTOMATED SAMPLE & VERIFY (4-DIGIT ADDITION) - Windows")
...
try:
    ...
    report_lines = []
    report_lines.append("4-DIGIT ARITHMETIC PROMPT EVAL REPORT")
