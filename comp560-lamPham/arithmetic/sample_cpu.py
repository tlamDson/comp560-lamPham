"""
CPU-based sampling (fallback if GPU sampling crashes).
...
print("AUTOMATED SAMPLE & VERIFY (CPU FALLBACK)")
...
try:
    ...
    report_lines = []
    report_lines.append("ARITHMETIC PROMPT EVAL REPORT (CPU)")
    ...
    print("\nSaved report to llm_output_cpu.txt")
