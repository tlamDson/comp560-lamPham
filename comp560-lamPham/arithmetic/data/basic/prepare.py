"""
Prepare a 3-digit addition dataset for character-level modeling.
Examples: "123+456=0579"
"""
import os
import pickle
import random
...
target_by_carry = {0: TARGET_PER_CARRY, 1: TARGET_PER_CARRY, 2: TARGET_PER_CARRY, 3: TARGET_PER_CARRY}
