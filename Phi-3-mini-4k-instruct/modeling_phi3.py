...
def _get_usable_cache_length(cache_obj, current_length, layer_idx=0):
    if hasattr(cache_obj, "get_usable_length"):
        try:
            return cache_obj.get_usable_length(current_length, layer_idx)
        except TypeError:
            return cache_obj.get_usable_length(current_length)
